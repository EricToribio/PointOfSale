...
export default (props: {page:string})=> {
    ...
    const header = props.page === "landing" ? "Point of Sale": props.page === "login" ? "Login" : props.page === "about" ? "About" : props.page === "demo" ? "Request a Demo" : props.page === "features" ? "Features" :
    ...
    return(
        ...
        <div className={`${isNavCollapsed ? 'collapse' : ''} navbar-collapse`} id="navbarsExample09">
          {props.page !== "about" && <a className="nav-link text-info" href="/about" >About Us</a>
    }
    {
        props.page !== "login" &&
