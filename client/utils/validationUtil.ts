...
export const registrationValidations = function (firstName: string, lastName: string, email: string, password: string, confirmPassword: string,shopName: string){
    let errors = new Map<string, string>();
    ...
    if (shopName.length < 5){
        errors.set("shopName", "Shop Name must be 5 characters long")
    }
