    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light rounded px-4">
      ...
      <div className={`${isNavCollapsed ? 'collapse ' : ''} navbar-collapse `} id="navbars">
        ...
        onMouseLeave={isNavCollapsed ? handleNull : handleNavCollapse}>
          {
            props.page !== "about" &&
            <a className="nav-link text-info p-2" href="/about" >About Us</a>
          }
          {
            props.page !== "login" &&
            <a className="nav-link text-info p-2" href="/login" >Login</a>
          }
          {
            props.page !== "features" &&
            <a href="/features" className=" nav-link text-info p-2" >Features</a>
          }
          {
            props.page !== "demo" &&
            <a href="/demo" className=" nav-link text-info p-2" >Request a Demo</a>
          }
          {
            props.page !== "landing" &&
            <a href="/" className=" nav-link text-info p-2" >Home</a>
          }
        </div>
      </div>
    </nav>
